...
export function MenuItem({ item, index }: MenuItemProps) {
  return (
    <FadeIn delay={index * 0.05}>
      <TiltCard maxTilt={3}>
        <div className="bg-pox-dark-surface rounded-2xl border border-pox-gold/20 overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-200">
