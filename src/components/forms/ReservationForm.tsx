  ...
  if (submitted) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-2xl font-heading font-bold text-pox-brown mb-2">
          ¡Reservación enviada!
        </h3>
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="fecha" className="block text-sm font-semibold text-pox-brown mb-1.5">
          ...
          <input
            ...
            type="date"
            min={minDate}
            className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-pox-gold focus:outline-none transition-colors"
            {...register("fecha")}
          />
          {errors.fecha && (
        ...
        <div>
          <label htmlFor="hora" className="block text-sm font-semibold text-pox-brown mb-1.5">
            Hora <span className="text-pox-red">*</span>
          </label>
          <select
            id="hora"
            className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-pox-gold focus:outline-none transition-colors bg-white"
            {...register("hora")}
          >
      ...
      {/* Personas counter */}
      <div>
        <label className="block text-sm font-semibold text-pox-brown mb-1.5">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="w-10 h-10 rounded-full bg-pox-cream flex items-center justify-center text-pox-brown hover:bg-pox-gold/20 transition-colors"
          >
            <Minus size={18} />
          </button>
          <span className="text-2xl font-heading font-bold text-pox-brown w-8 text-center">
            {personas}
          </span>
          <button
            type="button"
      ...
      <div>
        <label htmlFor="ocasion" className="block text-sm font-semibold text-pox-brown mb-1.5">
      ...
      <div>
        <label htmlFor="notas" className="block text-sm font-semibold text-pox-brown mb-1.5">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-pox-gold focus:outline-none transition-colors resize-none"
          {...register("notas")}
        />
      </div>
