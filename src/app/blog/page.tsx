          ...
          {blogPosts.map((post) => (
            <StaggerItem key={post.slug}>
              <Link href={`/blog/${post.slug}`} className="group block">
                <article className="bg-pox-dark-surface rounded-2xl overflow-hidden border border-pox-gold/20 hover:-translate-y-1 hover:shadow-xl transition-all duration-200">
